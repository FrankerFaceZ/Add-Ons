<template functional>
	<div :class="data.staticClass" class="bd--tag-list tw-font-size-7 tw-c-text-base">
		<div
		...
		>
			...
			>
				<div
					:class="[tag.isLanguageTag || tag.is_language ? 'ffz-i-language' : '']"
					class="ffz-tooltip tw-tag__content"
