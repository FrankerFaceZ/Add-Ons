		...
		if ( msg.type && msg.type === this.site_chat.chat_types?.Notice ) {
			...
			>
				...
				{createElement('span', user_props, override_name
					? [
						<span key={override_name} class="chat-author__display_name">{ override_name }</span>,
						<div key={username} class="ffz-il-tooltip ffz-il-tooldip--down ffz-il-tooltip--align-center">{ username }</div>
					]
					: username
				)}
